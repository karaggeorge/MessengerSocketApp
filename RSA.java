...
public class RSA {
  ...
  public RSA(int bits) {
    ...
    BigInteger p = new BigInteger(bitlen / 2, 1024, r);
    BigInteger q = new BigInteger(bitlen / 2, 1024, r);
    n = p.multiply(q);
...
//    }
  ...
  public synchronized String encrypt(String message, BigInteger newE) {
	    return (new BigInteger(message.getBytes())).modPow(newE, n).toString();
	  }
